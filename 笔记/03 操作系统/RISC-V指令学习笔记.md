...
![image-20230910222656894](x-RISC-V指令学习笔记/image-20230910222656894.png)
...
![](x-RISC-V指令学习笔记/声明变量的汇编命令-risc_v.png)
...
![](x-RISC-V指令学习笔记/Snipaste_2023-09-17_16-26-54.png)

下一个元素就是标签`msg:`。在这种情况下，汇编器（1）注册名叫`msg`的符号到符号表中，并为它分配一个地址从当前的`location counter`中。下图即是：

![](x-RISC-V指令学习笔记/Snipaste_2023-09-17_17-05-27.png)
...
![](x-RISC-V指令学习笔记/Snipaste_2023-09-17_17-09-10.png)
...
![](x-RISC-V指令学习笔记/Snipaste_2023-09-17_17-16-14.png)
...
![image-20231111163711237](x-RISC-V指令学习笔记/image-20231111163711237.png)
