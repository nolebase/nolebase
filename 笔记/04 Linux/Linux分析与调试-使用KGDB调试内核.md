...
```
接着会进入：
![[image-20240725205515146.png|image-20240725205515146.png]]
我们输入help：
...
执行上面命令后`target`会卡住。
我们看看`host`端，发现触发中断了：
![[image-20240725220151807.png|image-20240725220151807.png]]
...
![[image-20240727215221231.png|image-20240727215221231.png]]
接着在`target`上操作：
```shell
